...
public class KeycloakService {
        ...
        int statusId = 0;
         try {
             ...
             if(statusId == 201){
                 ...
                 message.setMessage("error creando el usuario " + statusId);
             }
         }catch (Exception e){
    ...
    private RealmResource getRealmResource(){
        Keycloak kc = KeycloakBuilder.builder().serverUrl(server_url).realm("master").username("chris.syst3@gmail.com")
                .password("Chris4589").clientId("admin-cli").resteasyClient(new ResteasyClientBuilder().connectionPoolSize(10).build())
                .build();
